...
export const schemaElements = {
  ...
  optional: (value: AnySchemaElement, opts?: SchemaElementOptions) => ({
    type: "optional",
    value,
    ...opts,
  }),
  ...
  literal: (
    ...
    opts?: SchemaElementOptions,
  ) => ({
    type: "literal",
    value,
    ...opts,
  }),
  tuple: (items: AnySchemaElement[], opts?: SchemaElementOptions) => ({
    type: "tuple",
    items,
    ...opts,
  }),
  array: (item: AnySchemaElement, opts?: SchemaElementOptions) => ({
    type: "array",
    item,
    ...opts,
  }),
  intersection: (
    left: AnySchemaElement,
    right: AnySchemaElement,
    opts?: SchemaElementOptions,
  ) => ({
    type: "intersection",
    left,
  ...
  union: (items: AnySchemaElement[], opts?: SchemaElementOptions) => ({
    type: "union",
    items,
    ...opts,
  }),
  nullable: (item: AnySchemaElement, opts?: SchemaElementOptions) => ({
    type: "nullable",
    item,
    ...opts,
  }),
  object: (
    properties: Record<string, AnySchemaElement>,
    opts?: SchemaElementOptions,
  ) => ({
    type: "object",
    properties,
  ...
  // biome-ignore lint/suspicious/noExplicitAny: we do not care about args here
...
export function is<
  Type extends keyof SchemaElementsMap = keyof SchemaElementsMap,
>(
  type: Type,
